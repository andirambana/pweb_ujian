...
<body>
    ...
    <h2 class="text-center mt-5">Update Data Siswa</h2>
    <form name="siswa" action="updatesiswa.php" method="post">
        <div class="mb-3 mt-5">
        <label for="nis" class="mb-2">Nomer Induk Siswa</label>
        <input type="text" class="form-control nis" id="nis" name="nis" value="<?php echo $result[0]; ?>" >
        </div>
        <div class="mb-3">
        ...
        <select class="form-select" id="jk" name="jk" required>
            <option selected disabled value=""><?php echo $result[2]; ?></option>
